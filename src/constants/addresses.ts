...
export const STAKING_ADDRESSES = {
  [NetworkId.TESTNET_RINKEBY]: "0xa8d8A528ABb732C71aEC8723906B6596eFFc6EBD",
  [NetworkId.MAINNET]: "0xB63cac384247597756545b500253ff8E607a8020",
};

export const GOHM_ADDRESSES = {
  [NetworkId.TESTNET_RINKEBY]: "0x0Cb6Db1Ce076310f6594629113f35bBcDc403Aa2",
...
export const WSOHM_ADDRESSES = {
  [NetworkId.TESTNET_RINKEBY]: "0x0235F7762e983F9FD22dBd4851A3ab69848e7187",
...
export const OHM_ADDRESSES = {
  [NetworkId.TESTNET_RINKEBY]: "0x63C7aA566d954d763006206aC2053827e9051c79",
  [NetworkId.MAINNET]: "0x64aa3364f17a4d01c6f1751fd97c2bd3d7e7f1d5",
};

export const V1_OHM_ADDRESSES = {
  [NetworkId.TESTNET_RINKEBY]: "0xE68305314744EA5e6AD321d4Edf0507473d629e9",
  [NetworkId.MAINNET]: "0x383518188c0c6d7730d91b2c03a03c837814a899",
};

export const SOHM_ADDRESSES = {
  [NetworkId.TESTNET_RINKEBY]: "0xDE74f1BA9419df6804446F7E3aAe9D60069BF9D2",
  [NetworkId.MAINNET]: "0x04906695D6D12CF5459975d7C3C03356E4Ccd460",
};

export const V1_SOHM_ADDRESSES = {
  [NetworkId.TESTNET_RINKEBY]: "0xEE173BCFfc24c4b637294EcAb025d46Ff46b4692",
